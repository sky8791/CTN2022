...
# 1.get train data
trainD,testD          = splitData(samples,num_clas,r=RATE,rs=0)
...
model                 = load_model('UP_model.h5',custom_objects={'GELU':GELU,'FeedForward':FeedForward,'LayerNormalization':LayerNormalization})
